...
import org.raistlic.tetris.controller.TetrisGameControllerFactory;

/**
 *
 * @author raistlic
 */
public class DefaultTetrisGameControllerFactory implements TetrisGameControllerFactory {

  @Override
  public TetrisGameController build() {
